...
make the header section title as centre aligned and three feature buttons in long three split buttons from left to right
make them modern asethetic that match the ui and also done by a student that is clean
make the title in a gradient colour
change the footer to mention only powered by assembly ai and groq ai
make these changes without affecting the other features or look of other things try to match with it
